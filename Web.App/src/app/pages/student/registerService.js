        ...
        .factory('registerService', 
            function(requestService) {
                ...
                var majors = [
                        ...
                        { label: 'Ingeniería en Computación', value : 4},
                        { label: 'Administración de Empresas', value : 3},
                        { label: 'Ingeniería en Agronomía', value : 2},
                        { label: 'Ingeniería en Producción Industrial', value : 5},
                        { label: 'Gestión del Turismo Rural Sostenible', value : 7},
                        { label: 'Ingeniería en Electrónica', value : 6},
                        { label: 'Estudiante Colegio Científico', value : 8}
                        ];
                ...
                var registerNewUser =  function registerNewUser(user, callback) {
                    ...
                    requestService.postRequest({params: "", data: user}, {url: '/registerNewUser'})
